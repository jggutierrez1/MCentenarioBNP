...
uses
  ...
  FireDAC.VCLUI.Error, FireDAC.VCLUI.Script, FireDAC.Comp.UI,
  FireDAC.Stan.ExprFuncs, FireDAC.Phys.SQLite,
  FireDAC.Phys.MySQL, FireDAC.Stan.Util, FireDAC.Phys.MySQLDef,
  FireDAC.Phys.SQLiteDef, FireDAC.VCLUI.Wait, FireDAC.VCLUI.Async,
  IdComponent,
  IdExplicitTLSClientServerBase, IdRawBase, IdRawClient, IdIcmpClient;
...
function Exec_Select_SQL(var oQry: TFDQuery; sSql: string; oQryExec: Boolean = False; oQryCreate: Boolean = True;
...
begin
  handle := Winapi.Windows.FindFirstFile(PChar(FileName), FindData);
  if handle <> INVALID_HANDLE_VALUE then
  begin
