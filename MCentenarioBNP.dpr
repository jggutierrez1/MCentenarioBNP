...
uses
  ...
  Proveedor in 'Proveedor.pas' {fProveedor},
  imports_1 in 'imports_1.pas' {fimports_1},
  Personal in 'Personal.pas' {fPersonal},
  change_val in 'change_val.pas' {fchange_val};
